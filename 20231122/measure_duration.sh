...
#     1. Collecting data with "features=enable_execution_duration_record,enable_tps_gas_record,enable_cache_record max Th".
#
#############################################################
...
#############################################################
pushd reth && \
RUSTFLAGS="-C target-cpu=native" cargo build --profile maxperf --features=finish_after_execution_stage,enable_execution_duration_record,enable_tps_gas_record,enable_cache_record && \
